...
function Header() {
  ...
  return (
    <header className="w-full h-[64px] bg-primary flex justify-center items-center fixed">
      <div className=" px-5 2xl:px-[142px] w-full flex justify-between items-center ">
        ...
        <div className="hidden md:flex gap-8">
          ...
          <div className="flex gap-5 items-center">
            <Link className="text-white font-semibold hover:text-secbg-secondary">
              Login
            </Link>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden w-1/2 h-lvh flex flex-col items-start p-4 bg-[#17171f]  absolute top-0 left-0 right-0  z-10">
          ...
          <Link
            className="text-white font-semibold hover:text-[#EE2f2f] mt-4 hidden lg:block"
            to="/login"
          >
            Login
          </Link>
          <button
            onClick={() => setRegisterModal(!registerModal)}
            className="font-semibold px-3 py-[4px] bg-[#EE2f2f] rounded-lg flex gap-1 items-center text-white mt-4 hidden lg:block"
          >
            Register <GoTriangleDown /> 
          </button>
          {registerModal && (

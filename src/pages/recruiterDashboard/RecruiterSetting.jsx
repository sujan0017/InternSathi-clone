        ...
        <div className="border bg-white rounded-md p-5 ">
          ...
          <ul className="flex flex-col gap-5 mt-5">
            <div className="flex items-center justify-between">
              <li>All notification</li> <ToggleSwitch />
            </div>
            <div className="flex items-center justify-between">
              <li>Notify me on new Internship post</li> <ToggleSwitch />
            </div>
            <div className="flex items-center justify-between">
              <li>Notify me on new event post</li> <ToggleSwitch />
            </div>
            <div className="flex items-center justify-between">
              <li>Notify me on Application Invitation</li> <ToggleSwitch />
            </div>
            <div className="flex items-center justify-between">
